...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
		...
		<div class="post">
			...
			<div class="entry">
				    ...
				    <table>
				    <tr><td><a href="http://wwww.microsoft.com" target="_blank"><img src="../../Content/Images/SponsorLogos/microsoft.jpg" alt="Microsoft" border="0" /></a></td>
				        <td><a href="http://www.quicksolutions.com" target="_blank"><img src="../../Content/Images/SponsorLogos/quicksolutions.jpg" alt="Quick Solutions" border="0" height="50%" width="50%" /></a></td>
				    </tr>
				    </table>
