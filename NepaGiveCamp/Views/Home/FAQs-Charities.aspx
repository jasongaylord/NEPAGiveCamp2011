...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	NEPA GiveCamp :: Frequently Asked Questions for Charities
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="f_body_content_left">
        ...
        <div class="heading2">For Charities</div><br />
        ...
        <div class="easyreading">
            ...
            <div class="faq">
                ...
                <div class="answer">
                    <p>The deadline for submitting proposals is <strong>December 31st <strike>10th</strike>, 2010.</strong></p>
                </div>
            </div>
            ...
            <div class="faq">
                ...
                <div class="answer">
                	<p>We're sure there will be press at the event, by the dates and times are yet to be determined.</p>
                </div>
            </div>
            ...
            <div class="faq">
                ...
                <div class="answer">
                    ...
                    estimate being able to help 15-20 charities.                	
                </div>
            </div>
            ...
            <div class="faq">
                ...
                <div class="answer">
                	<p>Please stop in and give your support to the developers that are working hard. There are other similar events being planned that you may want to submit your Charity Proposal information to. See <a href="http://www.givecamp.org" target="_blank">Givecamp.org</a> for information about other such events.</p>
                </div>
            </div>
            ...
            <div class="faq">
                ...
                <div class="answer">
                	<p>The selected charities will be published on the website on December 15th. Selected charities will also be emailed.</p>
                </div>
            </div>
        </div>
    </div>
