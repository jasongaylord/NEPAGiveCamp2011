...
namespace NepaGiveCamp.Controllers
{
    public class VolunteerController : Controller
    {
        ...
        private void Validate(Volunteer volunteer, List<JobRole> jobRoles, List<Technology> technologies)
        {
            ...
            if (volunteer.TShirtSize == null)
                ModelState.AddModelError("TShirtSize", "You must select your t-shirt size");
    ...
    public class SignUpViewModel
    {
        ...
        private void Construct(Volunteer volunteer)
        {
            ...
            var sizes = lookupRepository.GetAllShirtSizes();
            TShirtSizes = new SelectList(sizes);
