...
namespace NepaGiveCamp.Controllers
{
    public class CharityController : Controller
    {
       ...
       public ActionResult Index()
        ...
        private void Validate(CharityRequirement charity, List<Technology> infrastructure, List<Technology> support)
        {
            ...
            if (charity.BackgroundInformation != null)
            ...
            if (charity.OtherInfrastructure != null)
            ...
            if (charity.OtherSupportSkills != null)
    ...
    public class CharitySignUpViewModel
    {
        ...
        {
            CharityRequirement = charity ?? new CharityRequirement();
